...
const ETF_REGIONS: Record<string, Record<string, number>> = {
  ...
  IJR: { US: 100 },
  IWM: { US: 100 },
  // US sector ETFs (region stays US)
  XLK: { US: 100 },
  XLF: { US: 100 },
  XLV: { US: 100 },
  XLE: { US: 100 },
  ...
  VEA: { Europe: 50, Japan: 22, Canada: 8, Other: 20 },
  IEFA: { Europe: 52, Japan: 22, Asia: 12, Other: 14 },
  EFA: { Europe: 55, Japan: 22, Asia: 10, Other: 13 },
  SCHF: { Europe: 52, Japan: 22, Asia: 12, Other: 14 },
  // Emerging markets
  VWO: { Asia: 70, Other: 30 },
  IEMG: { Asia: 70, Other: 30 },
  EEM: { Asia: 70, Other: 30 },
  SCHE: { Asia: 70, Other: 30 },
  // Global / ex-US total
  VXUS: { Europe: 40, Japan: 17, Asia: 28, Canada: 6, Other: 9 },
  VT: { US: 60, Europe: 17, Japan: 7, Asia: 10, Canada: 3, Other: 3 },
  ACWI: { US: 60, Europe: 17, Japan: 7, Asia: 10, Canada: 3, Other: 3 },
  IXUS: { Europe: 40, Japan: 17, Asia: 28, Canada: 6, Other: 9 },
  // Bond / fixed income
  BND: { US: 100 },
  AGG: { US: 100 },
  TLT: { US: 100 },
  ...
  HYG: { US: 100 },
  MUB: { US: 100 },
  BNDX: { Europe: 55, Japan: 22, Asia: 10, Canada: 5, Other: 8 },
  VGLT: { US: 100 },
  VCIT: { US: 100 },
  VCSH: { US: 100 },
  // Real estate
  VNQ: { US: 100 },
  IYR: { US: 100 },
  VNQI: { Europe: 35, Japan: 25, Asia: 25, Canada: 5, Other: 10 },
  // Gold / commodities
  GLD: { Other: 100 },
  IAU: { Other: 100 },
  SLV: { Other: 100 },
  ...
  "XIU.TO": { Canada: 100 },
  "ZCN.TO": { Canada: 100 },
  "VGRO.TO": { US: 42, Canada: 24, Europe: 14, Japan: 6, Asia: 8, Other: 6 },
  "VEQT.TO": { US: 45, Canada: 30, Europe: 12, Japan: 5, Asia: 6, Other: 2 },
  "VBAL.TO": { US: 28, Canada: 36, Europe: 10, Japan: 4, Asia: 5, Other: 17 },
  "XEQT.TO": { US: 47, Canada: 25, Europe: 14, Japan: 5, Asia: 7, Other: 2 },
  "XGRO.TO": { US: 44, Canada: 23, Europe: 13, Japan: 5, Asia: 7, Other: 8 },
  "XBAL.TO": { US: 30, Canada: 28, Europe: 8, Japan: 3, Asia: 5, Other: 26 },
  "ZSP.TO": { US: 100 },
  "ZEA.TO": { Europe: 50, Japan: 22, Canada: 8, Other: 20 },
  "XEC.TO": { Asia: 70, Other: 30 },
  "XUU.TO": { US: 100 },
  "XEF.TO": { Europe: 52, Japan: 22, Asia: 12, Other: 14 },
  "VDY.TO": { Canada: 100 },
  "XAW.TO": { US: 60, Europe: 17, Japan: 7, Asia: 10, Canada: 3, Other: 3 },
};
...
const ETF_SECTORS: Record<string, Record<string, number>> = {
  ...
  VOO: { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  ...
  // US large-cap (S&P 500-ish)
  SPY: { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  IVV: { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  SPLG: { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  ITOT: { Tech: 30, Healthcare: 13, Financials: 13, Consumer: 12, Industrials: 10, Other: 22 },
  SCHB: { Tech: 30, Healthcare: 13, Financials: 13, Consumer: 12, Industrials: 10, Other: 22 },
  SCHX: { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  // NASDAQ / growth
  QQQ: { Tech: 50, Consumer: 18, Healthcare: 7, Industrials: 6, Other: 19 },
  VUG: { Tech: 48, Consumer: 20, Healthcare: 8, Other: 24 },
  VTV: { Financials: 22, Healthcare: 18, Industrials: 11, Consumer: 10, Energy: 7, Other: 32 },
  VYM: { Financials: 20, Healthcare: 14, Consumer: 13, Industrials: 11, Energy: 9, Other: 33 },
  SCHD: { Financials: 17, Healthcare: 16, Consumer: 14, Industrials: 12, Energy: 8, Other: 33 },
  DIA: { Financials: 18, Healthcare: 17, Tech: 17, Industrials: 13, Consumer: 12, Other: 23 },
  // US sector ETFs
  XLK: { Tech: 100 },
  XLF: { Financials: 100 },
  XLV: { Healthcare: 100 },
  ...
  VFH: { Financials: 100 },
  // International
  VEA: { Financials: 19, Industrials: 16, Healthcare: 11, Consumer: 11, Tech: 9, Materials: 8, Energy: 5, Other: 21 },
  IEFA: { Financials: 19, Industrials: 16, Healthcare: 11, Consumer: 11, Tech: 9, Materials: 8, Energy: 5, Other: 21 },
  VWO: { Financials: 22, Tech: 20, Consumer: 12, Industrials: 8, Materials: 8, Energy: 6, Healthcare: 5, Other: 19 },
  VXUS: { Financials: 19, Industrials: 14, Tech: 13, Consumer: 11, Healthcare: 9, Materials: 7, Energy: 5, Other: 22 },
  VT: { Tech: 24, Financials: 16, Healthcare: 11, Consumer: 12, Industrials: 10, Energy: 5, Materials: 4, Other: 18 },
  // Bonds (empty sector — bonds are classified by credit/duration, not sector)
  BND: { Other: 100 },
  AGG: { Other: 100 },
  TLT: { Other: 100 },
  // Real estate
  ...
  "VFV.TO": { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  "XIC.TO": { Financials: 35, Energy: 16, Industrials: 11, Materials: 10, Tech: 8, Other: 20 },
  "XIU.TO": { Financials: 37, Energy: 17, Industrials: 11, Materials: 10, Tech: 6, Other: 19 },
  "ZCN.TO": { Financials: 35, Energy: 16, Industrials: 11, Materials: 10, Tech: 8, Other: 20 },
  "VDY.TO": { Financials: 60, Energy: 15, Other: 25 },
  "ZSP.TO": { Tech: 32, Healthcare: 13, Financials: 13, Consumer: 11, Industrials: 9, Other: 22 },
  "ZEA.TO": { Financials: 19, Industrials: 16, Healthcare: 11, Consumer: 11, Tech: 9, Materials: 8, Energy: 5, Other: 21 },
  "XEC.TO": { Financials: 22, Tech: 20, Consumer: 12, Industrials: 8, Materials: 8, Energy: 6, Healthcare: 5, Other: 19 },
  "XEF.TO": { Financials: 19, Industrials: 16, Healthcare: 11, Consumer: 11, Tech: 9, Materials: 8, Energy: 5, Other: 21 },
  "XEQT.TO": { Tech: 22, Financials: 18, Healthcare: 10, Consumer: 11, Industrials: 10, Energy: 5, Materials: 4, Other: 20 },
  "XGRO.TO": { Tech: 20, Financials: 18, Healthcare: 9, Consumer: 11, Industrials: 10, Energy: 5, Materials: 4, Other: 23 },
  "VEQT.TO": { Tech: 22, Financials: 18, Healthcare: 10, Consumer: 11, Industrials: 10, Energy: 5, Materials: 4, Other: 20 },
  "VGRO.TO": { Tech: 20, Financials: 18, Healthcare: 9, Consumer: 11, Industrials: 10, Energy: 5, Materials: 4, Other: 23 },
  "VBAL.TO": { Financials: 15, Tech: 14, Healthcare: 7, Consumer: 8, Industrials: 8, Energy: 4, Materials: 3, Other: 41 },
  "XBAL.TO": { Financials: 15, Tech: 14, Healthcare: 7, Consumer: 8, Industrials: 8, Energy: 4, Materials: 3, Other: 41 },
  "XUU.TO": { Tech: 30, Healthcare: 13, Financials: 13, Consumer: 12, Industrials: 10, Other: 22 },
  "XAW.TO": { Tech: 24, Financials: 16, Healthcare: 11, Consumer: 12, Industrials: 10, Energy: 5, Materials: 4, Other: 18 },
};
